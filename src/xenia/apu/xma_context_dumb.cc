...
XmaContext::XmaContext()
    : read_pos_(0),
      write_pos_(0),
      buffer_capacity_(48000 * 2) {  // 1 second stereo buffer
...
size_t XmaContext::DecodePacket(const uint8_t* packet, size_t packet_size,
                                float* out_buffer, size_t max_frames) {
