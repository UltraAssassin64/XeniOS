...
void EmitAdd(A64Emitter& e, const oaknut::XReg& dst, const oaknut::XReg& src1,
             const oaknut::XReg& src2);

void EmitSub(A64Emitter& e, const oaknut::XReg& dst, const oaknut::XReg& src1,
             const oaknut::XReg& src2);

void EmitMul(A64Emitter& e, const oaknut::XReg& dst, const oaknut::XReg& src1,
             const oaknut::XReg& src2);
